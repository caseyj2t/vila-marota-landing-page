const translations = {
  pt: {
    ...
    navInfo: 'Informações',
    navContact: 'Contato',
    heroBadge: '📍 Pindobaçu • Bahia • Brasil',
    ...
    ratingCount: '33 avaliações',
    testimonial1: 'Muito bom, melhor cidade da região.',
    testimonial2: 'Lugar de pessoas aconchegantes e legais.',
    testimonial3: 'Povo bom e acolhedor.',
    ...
    galleryCaption1: 'Vista da Vila Marota',
    galleryCaption2: 'Ruas da comunidade',
    galleryCaption3: 'Paisagem local',
    galleryCaption4: 'Vida cotidiana',
    galleryCaption5: 'Natureza e horizonte',
    galleryCaption6: 'Charme do interior',
    galleryAlt1: 'Marota imagem 1',
    galleryAlt2: 'Marota imagem 2',
    galleryAlt3: 'Marota imagem 3',
    galleryAlt4: 'Marota imagem 4',
    galleryAlt5: 'Marota imagem 5',
    galleryAlt6: 'Marota imagem 6',
  ...
  en: {
    ...
    ratingCount: '33 reviews',
    testimonial1: 'Very good, best town in the region.',
    testimonial2: 'Place of friendly and kind people.',
    testimonial3: 'Good and welcoming people.',
    ...
    galleryCaption1: 'View of Vila Marota',
    galleryCaption2: 'Neighborhood streets',
    galleryCaption3: 'Local landscape',
    galleryCaption4: 'Everyday life',
    galleryCaption5: 'Nature and horizon',
    galleryCaption6: 'Rustic charm',
    galleryAlt1: 'Marota image 1',
    galleryAlt2: 'Marota image 2',
    galleryAlt3: 'Marota image 3',
    galleryAlt4: 'Marota image 4',
    galleryAlt5: 'Marota image 5',
    galleryAlt6: 'Marota image 6',
  ...
  es: {
    ...
    navInfo: 'Información',
    navContact: 'Contacto',
    heroBadge: '📍 Pindobaçu • Bahía • Brasil',
    ...
    ratingCount: '33 reseñas',
    testimonial1: 'Muy bueno, mejor pueblo de la región.',
    testimonial2: 'Lugar de personas acogedoras y amables.',
    testimonial3: 'Gente buena y acogedora.',
    ...
    galleryCaption1: 'Vista de Vila Marota',
    galleryCaption2: 'Calles de la comunidad',
    galleryCaption3: 'Paisaje local',
    galleryCaption4: 'Vida cotidiana',
    galleryCaption5: 'Naturaleza y horizonte',
    galleryCaption6: 'Encanto rústico',
    galleryAlt1: 'Imagen de Marota 1',
    galleryAlt2: 'Imagen de Marota 2',
    galleryAlt3: 'Imagen de Marota 3',
    galleryAlt4: 'Imagen de Marota 4',
    galleryAlt5: 'Imagen de Marota 5',
    galleryAlt6: 'Imagen de Marota 6',
